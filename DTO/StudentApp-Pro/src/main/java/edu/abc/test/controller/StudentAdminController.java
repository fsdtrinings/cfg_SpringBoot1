...
import edu.abc.test.dtoconvertor.StudentDTOConvertor;
...
public class StudentAdminController {
	...
	@GetMapping("/students")
	public ResponseEntity<List<AdminStudentResponseDTO>> getAllStudents()
	{
		List<Student> allSavedStudents =  studentService.getAllStudents();
	
		List<AdminStudentResponseDTO> dtoList =  StudentDTOConvertor.getAllStudentDTO(allSavedStudents);
		return new ResponseEntity<List<AdminStudentResponseDTO>>(dtoList,HttpStatus.OK);
	}
	...
	public Student linkLaptopWithStudent
	            (@RequestParam( required =  true) int sid , @RequestParam int laptopid)
